...
<Section class="pt-32 pb-24 min-h-screen relative">
  ...
  <div class="absolute inset-0 bg-[linear-gradient(to_right,#88888812_1px,transparent_1px),linear-gradient(to_bottom,#88888812_1px,transparent_1px)] bg-[size:3rem_3rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)] pointer-events-none z-0"></div>

  <Container class="relative z-10">
    <header class="max-w-4xl mb-20 space-y-6">
      <Reveal animation="fade-in">
        <div class="flex items-center justify-between mb-4">
          <div class="flex items-center gap-2 text-[10px] uppercase font-bold tracking-[0.3em] text-[var(--color-accent)]">
            <a href="/" class="hover:opacity-70 transition-opacity">Home</a>
            <span class="opacity-30">/</span>
            <span>Archive</span>
          </div>
          <div class="hidden md:block text-[10px] uppercase font-mono tracking-widest text-[var(--color-base-muted)] border border-[var(--color-base-muted)]/20 px-3 py-1 rounded-sm">
    ...
    <Stagger stagger={0.1}>
      <div class="flex flex-col gap-6 pt-12 border-t border-[var(--color-base-muted)]/10">
